...
# --- CONFIGURATION ---
SERIAL_PORT = "COM6"  # Update with your Arduino port
BAUD_RATE = 9600
AUTHORIZED_ID = "0013069760"
# ---------------------


def detect_circle(rduino):
    """
    ...
    rduino.reset_input_buffer()
    rduino.write(b'R')  # Trigger Arduino data stream
    ...
    while time.time() - start_time < timeout:
        raw = rduino.readline().decode(errors='ignore').strip()
...
def main():
    ...
    try:
        ...
        rduino.write(b'0')  # Ensure locked on exit
        rduino.close()
